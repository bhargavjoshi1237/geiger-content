...
// tab, open entry, and editor section. Mirrors geiger-events'
// use-workspace-url: the project and tab live in the PATH, the open entry and
// editor section live in the query string.
//
// Schema:  /project/<uuid>/<tabSlug>?content=<id>&section=<key>
...
//   - ?content= → open entry id (list swaps to its detail screen).
...
export function useWorkspaceUrl() {
  ...
  const buildUrl = useCallback(
    ...
    [projectId, tab, contentId, section, pathname],
  );
